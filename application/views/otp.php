    ...
    <div class="container">
        ...
        <div class="row" id="login">
            ...
            <div class="col-md-6">
                ...
                <form action="<?php echo base_url()?>otp/otp" method="post">
                    <div class="form-row">
                        <div class="form-group col-md-12">
                            <label  class="col-form-label">OTP</label>
                            <input type="text" class="form-control" id="inputtext" placeholder="otp" required="" name="otp">
                        </div>
...
<footer>
    <div class="row border-top mt-4 pt-lg-4 pt-3 text-lg-left text-center">
        <p class="col-lg-8 copy-right-grids mt-lg-1">© 2022 Credit Card Fraud Detection | Design by Chitra
