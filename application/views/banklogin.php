...
<div class="main-about">
    <div class="container">
        ...
        <div class="row" id="login">
            ...
            <div class="col-md-6">
                <!--                        <h4>LOGIN FORM</h4>-->
                <form action="<?php echo base_url()?>banklogin/banklogin" method="post">
                    <div class="form-row">
                        <div class="form-group col-md-12">
                            <label  class="col-form-label">Username</label>
                            <input type="text" class="form-control" id="inputtext" placeholder="Username"  name="banklogin" required="">
                        </div>
                        <div class="form-group col-md-12">
                            <label  class="col-form-label">Password</label>
                            <input type="text" class="form-control" id="inputEmail4" placeholder="Password" name="bankpassword" required="">
                        </div>
...
<footer>
    <div class="row border-top mt-4 pt-lg-4 pt-3 text-lg-left text-center">
        <p class="col-lg-8 copy-right-grids mt-lg-1">© 2022 Credit Card Fraud. All Rights Reserved | Design by chitra
