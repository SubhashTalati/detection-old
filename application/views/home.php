                        ...
                        <form action="<?php echo base_url()?>home/home" method="post">
                            <div class="form-row">
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text" class="form-control" id="inputtext" placeholder="Username" name="user" required="">
                                </div>
                                <div class="form-group col-md-12">
                                    <label  class="col-form-label">Password</label>
                                    <input type="password" class="form-control" id="inputEmail4" placeholder="Password" name="pass" required="">
                                </div>
<!--                                <div class="form-group col-md-12">-->
<!--                                    <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" placeholder="Text Hear" required=""></textarea>-->
<!--                                </div>-->
                                <input type="submit" class="form-button" value="SUBMIT"><br>

                            </div>
							
                        </form>

                       <b style="margin-left: 50px">New User Plesae</b> <a href="register"> Register Here</a>
                    </div>
                </div>
