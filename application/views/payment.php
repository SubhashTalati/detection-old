...
<div class="main-about">
    <div class="container">
        ...
        <div class="row" id="login">
            ...
            <div class="col-md-6">
                <!--                        <h4>LOGIN FORM</h4>-->
                <form action="<?php echo base_url()?>payment/payment" method="post">
                    <div class="form-row">
                        <div class="form-group col-md-12">
                            <label  class="col-form-label">Card Number</label>
                            <input type="text" class="form-control" id="inputtext" placeholder="CardNumber"  name="cardnum"  required="">
                        </div>
                        <div class="form-group col-md-12">
                            <label  class="col-form-label">CVV Number</label>
                            <input type="number" class="form-control" id="inputEmail4" placeholder="CVVNumber" name="cvvnum" required="">
                        </div>
                        <div class="form-group col-md-12">
                            <label  class="col-form-label">Expiry Date</label>
                            <input type="date" class="form-control" id="inputEmail4" placeholder="Expirydate" name="expirydate" required="">
                        </div>
                        <!--                                <div class="form-group col-md-12">-->
                        <!--                                    <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" placeholder="Text Hear" required=""></textarea>-->
                        <!--                                </div>-->
                        <input type="submit" class="form-button" value="OTP">
                    </div>
                </form>
            </div>
        </div>
