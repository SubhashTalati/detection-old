...
<!--<div class="col-md-2"></div>-->
            <div class="col-md-7" style="margin-left: 200px">
                <table class="table table-bordered table-responsive">
                    ...
                    ?>
                    <tr>
                        <td><?php echo $gat['id']?></td>
                        <td><?php echo $gat['uid']?></td>
                        <td><?php echo $gat['productname']?></td>
                        <td><?php echo $gat['quantity']?></td>
                        <td><?php echo $gat['cost']?></td>
                        <td><?php echo $gat['total']?></td>
                        <td><a href="<?php echo base_url()?>previousorder/complete?id=<?php echo $gat['id']?>"><?php echo $gat['status']?></a></td>
