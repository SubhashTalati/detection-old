    ...
    <div class="container">
        ...
        <div class="row" id="login">
            ...
            <div class="col-md-6">
                ...
                <form action="<?php echo base_url()?>ques2/texttwo" method="post">
                    <div class="form-row">
                        <div class="form-group col-md-12">
                            <?php
                            foreach ($carts as $cart) {
                                ?>
                                <label class="col-form-label"><?php echo $cart['texttwo']?></label>
                                <?php
                            }
                            ?>
                            <input type="text" class="form-control" id="inputtext" required="" name="ques2">
                        </div>
