                ...
                <form action="<?php echo base_url()?>login/login" method="post">
                    <div class="form-row">
                        <div class="form-group col-md-12">
                            <label  class="col-form-label">Adminname</label>
                            <input type="text" class="form-control" id="inputtext" placeholder="Adminname" required="" name="adminname">
                        </div>
                        <div class="form-group col-md-12">
                            <label  class="col-form-label">Password</label>
                            <input type="text" class="form-control" id="inputEmail4" placeholder="Password" required="" name="password">
                        </div>
