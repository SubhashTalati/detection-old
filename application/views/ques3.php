    ...
    <div class="container">
        ...
        <div class="row" id="login">
            ...
            <div class="col-md-6">
                ...
                <form action="<?php echo base_url()?>ques3/textthree" method="post">
                    <div class="form-row">
                        <div class="form-group col-md-12">
                            <?php
                            foreach ($rats as $rat) {
                                ?>
                                <label class="col-form-label"><?php echo $rat['textthree']?></label>
                                <?php
                            }
                            ?>
                            <input type="text" class="form-control" id="inputtext" required="" name="ques3">
                        </div>
