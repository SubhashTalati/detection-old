                ...
                <table>
                    ...
                    foreach ($parts as $part) {
                        ...
                        <tr>
                            ...
                            <td><?php echo $part['uid']?></td>
                            <td><?php echo $part['productname']?></td>
                            <td><?php echo $part['quantity']?></td>
                            <td><?php echo $part['cost']?></td>
                            <td><?php echo $part['total']?></td>
                            <td><a href="<?php echo base_url()?>neworder/status?id=<?php echo $part['id']?>"><?php echo $part['status']?></a></td>
...
<!--                                <input type="text" class="form-control" id="inputtext" placeholder="Cost" required="">-->
<!--                            </div>-->
<!--                            <div class="form-group col-md-12">-->
<!--                                <label  class="col-form-label">status</label>-->
<!--                                <input type="email" class="form-control" id="inputEmail4" placeholder="description" required="">-->
<!--                            </div>-->
<!---->
