                ...
                <form action="<?php echo base_url()?>addproduct/add" method="post" enctype="multipart/form-data">
                    <div class="form-row">
                        <div class="form-group col-md-12">
                            ...
                            <input type="text" class="form-control" id="inputtext" placeholder="ProductName" required="" name="productname">
                        </div>
                        <div class="form-group col-md-12">
                            <label  class="col-form-label">Category</label>
                            <select style="width: 540px;height: 40px;" name="category">
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <select style="width: 540px;height: 40px;" name="subcategory">
                                <option value="select">--Select--</option>
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <input type="text" class="form-control" id="inputEmail4" placeholder="Cost" required="" name="cost">
                        </div>

                        <div class="form-group col-md-12">
                            <label  class="col-form-label">Description</label>
                            <input type="text" class="form-control" id="inputEmail4" placeholder="Description" required="" name="description">
                        </div>

                        <div class="form-group col-md-12">
                            <label  class="col-form-label">Quantity</label>
                            <input type="text" class="form-control" id="inputEmail4" placeholder="Quantity" required="" name="quantity">
                        </div>
                        
                        <div class="form-group col-md-12">
                            <label  class="col-form-label">Image Choose </label>
                            <input type="file" class="form-control"  required="" name="pics">
                        </div>
